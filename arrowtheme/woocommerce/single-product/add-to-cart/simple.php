...
<?php endif; ?>
<!--/--><?php //echo '<span>'.arrow_get_option('button_buy_before').get_woocommerce_currency_symbol().get_post_meta( get_the_ID(), '_regular_price',true).'</span>'.arrow_get_option('button_buy'); ?>