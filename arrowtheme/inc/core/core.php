 ...
 */
if ( ! function_exists( 'arrow_wp_registered_sidebars' ) ) {
	function arrow_wp_registered_sidebars() {
 ...
 */
if ( ! function_exists( 'arrow_generate_html_terms_list' ) ) {
	function arrow_generate_html_terms_list( $post_id, $taxonomy, $is_link = true, $space = ',' ) {
 ...
 */
if ( ! function_exists( 'arrow_get_excerpt_by_id' ) ) {
	function arrow_get_excerpt_by_id( $post_id, $length ) {
...
if ( ! function_exists( 'arrow_get_menu_location' ) ) {
	function arrow_get_menu_location( $menu_location, $title = false ) {
		$html = array();
		if ( $title ) {
		...
		if ( has_nav_menu( $menu_location ) ) {
			...
			wp_nav_menu( array(
				...
				'container'      => '',
				'link_before'    => '<span class="arrow-link-inner">',
				'link_after'     => '</span>',
			) );
		}
...
if ( ! function_exists( 'arrow_get_language_location' ) ) {
	function arrow_get_language_location() {
		$html = array();
...
if ( ! function_exists( 'arrow_check_function_language' ) ) {
	function arrow_check_function_language( $function_name = '' ) {
		$check = $function_name();
		if ( function_exists( 'pll_current_language' ) ) {
			$isLang = pll_current_language();
